"""
Django settings for training_43820 project.
...
ROOT_URLCONF = 'training_43820.urls'
...
WSGI_APPLICATION = 'training_43820.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "training_43820 API",
    "DESCRIPTION": "API documentation for training_43820 App",
    "VERSION": "v1",
}
